...
Shader "Universal Render Pipeline/Custom/ToonShader"
{
    Properties
    {
        ...
        _ShadowToneMap("ShadowToneMap", 2D) = "white" {}
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half3 LightingToon(BRDFData brdfData, half3 lightColor, half3 lightDirectionWS, half lightAttenuation, half3 normalWS, half3 viewDirectionWS)
            {
                ...
                NdotL = tex2D(_ShadowToneMap, half2((1-NdotL), .5));
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                color += LightingToon(brdfData, mainLight, normalWS, viewDirectionWS);

                // Additional lights loop
#ifdef _ADDITIONAL_LIGHTS

                // Returns the amount of lights affecting the object being rendered.
                ...
                for (int i = 0; i < additionalLightsCount; ++i)
                {
                    ...
                    color += LightingToon(brdfData, light, normalWS, viewDirectionWS);
                }
#endif
                // Emission
